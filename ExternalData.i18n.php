...
$messages['he'] = array(
	...
	'externaldata-json-decode-not-supported' => 'שגיאה: הפקודה json_decode() אינה נתמכת בגירסה זו של PHP',
	'externaldata-xml-error' => 'שגיאת XML: $1 בשורה $2',
	'externaldata-db-incomplete-information' => '<p>שגיאה: מידע חלקי עבור מספר השרת הזה.</p>\\n',
	'externaldata-db-could-not-get-url' => 'לא ניתן לאחזר את הכתובת לאחר {{PLURAL:$1|נסיון אחד|$1 נסיונות}}.\\n\\n',
	'externaldata-db-unknown-type' => '<p>שגיאה: סוג בסיס הנתונים אינו מוכר.</p>\\n',
...
$messages['lb'] = array(
	...
	'externaldata-ldap-unable-to-connect' => 'Onméiglech sech op $1\\n ze connectéieren',
...
$messages['pt-br'] = array(
	...
	'externaldata-xml-error' => 'Erro no XML: $1 na linha $2',
	'externaldata-db-incomplete-information' => '<p>Erro: Informação incompleta para o ID deste servidor</P>\\n',
	'externaldata-db-could-not-get-url' => 'Não foi possível obter o URL após $1 {{PLURAL:$1|tentativa|tentativas}}.\\n\\n',
	'externaldata-db-unknown-type' => '<p>Erro: Tipo de base de dados desconhecido.</p>\\n',
	'externaldata-db-could-not-connect' => '<p>Erro: Não foi possível conectar-se a base de dados.</p>\\n',
	'externaldata-db-no-return-values' => '<p>Erro: Nenhum valor de retorno especificado.</p>\\n',
